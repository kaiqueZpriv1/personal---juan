				...
				<div className='container-about'>
					<AboutText>
						...
						<p className='paragrafo-about'>
							...
							congue est vitae eros vulputate pellentesque. Vestibulum accumsan
							risus nibh, a posuere velit semper ut. Integer consectetur ligula
							non massa sollicitudin, ut dignissim sem semper. Quisque semper
							sapien vitae ligula dictum, at efficitur diam suscipit.
						</p>
						<ButtonAbout>
